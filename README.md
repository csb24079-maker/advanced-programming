...
2. Implement the following methods: List getTopNStudents(List students, int n); Map<String, Double> getAverageScorePerCourse(List students); Set getAllUniqueCourses(List students);
Must use:
